...
import by.bstu.di.configurator.InjectByTypeAnnotationObjectConfigurator;
import by.bstu.di.configurator.InjectRandomIntObjectConfigurator;
...
public class ObjectFactory {
    ...
    private final Reflections scanner = new Reflections("by.bstu");
